...
class Burak757:
    def __init__(self):
        # Initialize the seat map and booking database
    ...
    def generate_booking_reference(self):
        # Generate a unique booking reference with 6 alphanumeric characters
    ...
    def free_seat(self, row, col):
        ...
        booking_ref = self.seat_map[row][col]
        if booking_ref in self.booking_db:
            del self.booking_db[booking_ref]
    ...
    def run(self):
        ...
        while True:
            ...
            if choice == '1':
                ...
                for ref, details in self.booking_db.items():
                    print(f"{ref}: {details}")
            elif choice == '5':
